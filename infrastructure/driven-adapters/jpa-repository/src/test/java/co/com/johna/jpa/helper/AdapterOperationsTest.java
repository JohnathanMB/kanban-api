package co.com.johna.jpa.helper;

import co.com.johna.jpa.TaskCardDataRepository;
import co.com.johna.jpa.TaskCardRepositoryAdapter;
...
class AdapterOperationsTest {
    ...
    @Mock
    private TaskCardDataRepository repository;

    @Mock
    private ObjectMapper objectMapper;

    private TaskCardRepositoryAdapter adapter;
    ...
    void setUp() {
        ...
        adapter = new TaskCardRepositoryAdapter(repository, objectMapper);
    }
